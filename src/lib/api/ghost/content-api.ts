...
export function createContentApiFromEnv() {
  ...
  const contentApiUrl = process.env.GHOST_CONTENT_API_URL || import.meta.env.GHOST_CONTENT_API_URL;
  const key = process.env.GHOST_CONTENT_API_KEY || import.meta.env.GHOST_CONTENT_API_KEY;
